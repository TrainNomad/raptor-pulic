...
const TRAIN_TYPE_STYLES = {
  ...
  'REGIONALE_IT':    { bg: '#009246', label: 'Regionale' },
  'IC_IT':           { bg: '#2a5a8b', label: 'Intercity IT' },
  'IC_SNCB':         { bg: '#003082', label: 'IC SNCB' },
  'NIGHTJET':        { bg: '#1a1a2e', label: 'Nightjet' },
  'EURONIGHT':       { bg: '#1a2a4a', label: 'EuroNight' },
  'OUIGO_ES':        { bg: '#e80082', label: 'Ouigo España' },
  'AVE_INT':         { bg: '#82245d', label: 'AVE Int.' },
  'ALVIA':           { bg: '#82245d', label: 'Alvia' },
  'AVLO':            { bg: '#e80050', label: 'Avlo' },
  'AVANT':           { bg: '#82245d', label: 'Avant' },
  'EUROMED':         { bg: '#82245d', label: 'Euromed' },
  'INTERCITY_ES':    { bg: '#5e1b43', label: 'Intercity' },
  'MD':              { bg: '#5e1b43', label: 'Media Dist.' },
  'REGIONAL_ES':     { bg: '#5e1b43', label: 'Regional' },
  'REG_EXP':         { bg: '#5e1b43', label: 'Reg. Exp.' },
};
